...
export default class ReturnItem extends Component {
    ...
    constructor(props) {
     ...
     render(){
        return (
                <div className='container container-fluid mt-4 BookItems' id={"item"+this.props.id}>
                    <div className='row'>
                    ...
                    this.props.StateModifier();
                      setTimeout(() => {
                        ...
                        this.props.StateModifier();
                                ...
                                <input type="button" className="form-control btn btn-danger m-md-2 my-2" value="Deny" onClick={()=>{
                                     document.getElementById("item"+this.props.id).style.display="none";
                                     new Network().hit(
                            "DenyReturnRequest", 
                            {id: this.props.id},
